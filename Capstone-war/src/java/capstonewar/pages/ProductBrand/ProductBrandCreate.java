 ...
 *
 * @version ProductBrandCreate.java
 * @version Created on Oct 5, 2017, 2:55:21 PM
 * @author Jefferson Van
 */

public class ProductBrandCreate extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("ProductBrandCreate Initialization Failure", e);
