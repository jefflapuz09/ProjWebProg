 ...
 *
 * @version ProductUnitCreate.java
 * @version Created on Sep 27, 2017, 9:24:31 AM
 * @author Jefferson Van
 */

public class ProductUnitCreate extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("ProductUnitCreate Initialization Failure", e);
...
//            unitCategory =  Short.parseInt(category.getValue().toString());
            ...
            productUnitFacade.create(pUnit);
