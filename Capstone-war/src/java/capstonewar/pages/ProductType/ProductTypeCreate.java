 ...
 *
 * @version ProductTypeCreate.java
 * @version Created on Oct 5, 2017, 4:01:46 PM
 * @author Jefferson Van
 */

public class ProductTypeCreate extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("ProductTypeCreate Initialization Failure", e);
