 ...
 *
 * @version ProductUpdate.java
 * @version Created on Oct 8, 2017, 6:50:40 PM
 * @author Jefferson Van
 */

public class ProductUpdate extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("ProductUpdate Initialization Failure", e);
    ...
    public void prerender() {
        ...
        Product prodEntry = sb1.getProductEdit();
        txtProduct.setText(prodEntry.getName());
        txtReorder.setText(prodEntry.getReorder());
        txtPrice.setText(prodEntry.getPrice());
        txtDescription.setText(prodEntry.getDescription());
