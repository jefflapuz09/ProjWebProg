 ...
 *
 * @version SupplierMaintenanceUpdate.java
 * @version Created on Sep 26, 2017, 10:20:46 PM
...
public class SupplierMaintenanceUpdate extends AbstractPageBean {
     ...
     */
    public SupplierMaintenanceUpdate() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("SupplierMaintenanceUpdate Initialization Failure", e);
    ...
    public void prerender() {
        ...
        txtSupplier.setText(suppEntry.getName());
        txtSt.setText(suppEntry.getStreet());
...
//        txtPContactNum.setText(suppPersonEntry.getSpContact());
    ...
    public void txtSupplier_processValueChange(ValueChangeEvent event) {
    }
