                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:button actionExpression="#{pages$ProductBrand$ProductBrandCreate.btnSave_action}"
                            binding="#{pages$Discount$DiscountCreate.btnSave}" id="btnSave" style="left: 287px; top: 480px; position: absolute" text="Save"/>
                        ...
                        <webuijsf:textField binding="#{pages$Discount$DiscountCreate.txtName}" columns="40" id="txtName" style="font-size: 18px; left: 288px; top: 216px; position: absolute"/>
                        ...
                        <webuijsf:button actionExpression="#{pages$ProductBrand$ProductBrandCreate.btnBack_action}"
                            binding="#{pages$Discount$DiscountCreate.btnBack}" id="btnBack" style="left: 287px; top: 456px; position: absolute" text="Back"/>
                        ...
                        <webuijsf:textField columns="40" id="textField1" style="font-size: 18px; left: 288px; top: 288px; position: absolute"/>
                        ...
                        <webuijsf:radioButtonGroup columns="2" id="radioButtonGroup1"
                            items="#{pages$Discount$DiscountCreate.radioButtonGroup1DefaultOptions.options}" style="font-size: 18px; left: 288px; top: 360px; position: absolute"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
