                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        <webuijsf:panelLayout id="layoutPanel1" panelLayout="flow" style="background-color: rgb(34, 45, 50); height: 662px; left: 0px; top: 0px; position: absolute; width: 238px">
                            <webuijsf:hyperlink actionExpression="#{pages$ProductUnit$ProductUnitMaintenance.hyperlink1_action}" id="hyperlink1"/>
                            <webuijsf:hyperlink actionExpression="#{pages$ProductUnit$ProductUnitMaintenance.btnMenu_action}"
                                binding="#{pages$ProductUnit$ProductUnitMaintenance.btnMenu}" id="btnMenu"
                        ...
                        <webuijsf:button actionExpression="#{pages$ProductUnit$ProductUnitMaintenance.btnNew_action}"
                            binding="#{pages$ProductUnit$ProductUnitMaintenance.btnNew}" id="btnNew"
                        ...
                        <webuijsf:table augmentTitle="false" id="table1" style="height: 197px; left: 312px; top: 240px; position: absolute" title="Table" width="888">
                            <webuijsf:tableRowGroup binding="#{pages$ProductUnit$ProductUnitMaintenance.tableRowGroup1}" id="tableRowGroup1" rows="10"
                                ...
                                <webuijsf:tableColumn headerText="Actions" id="tableColumn3" width="353">
                                    <webuijsf:button actionExpression="#{pages$ProductUnit$ProductUnitMaintenance.button1_action}" id="button1"
                                        style="font-size: 18px" text="Update"/>
                                    <webuijsf:button actionExpression="#{pages$ProductUnit$ProductUnitMaintenance.btnDelete_action}" id="btnDelete"
                        ...
                        <webuijsf:textField binding="#{pages$ProductUnit$ProductUnitMaintenance.txtSearch}" columns="40" id="txtSearch" style="font-size: 18px; left: 528px; top: 192px; position: absolute"/>
                        <webuijsf:button actionExpression="#{pages$ProductUnit$ProductUnitMaintenance.btnSearch_action}"
                            binding="#{pages$ProductUnit$ProductUnitMaintenance.btnSearch}" id="btnSearch"
                            style="font-size: 18px; left: 935px; top: 192px; position: absolute" text="Submit"/>
                        <webuijsf:checkbox binding="#{pages$ProductUnit$ProductUnitMaintenance.all}" id="all" label="View all"
                            onClick="webui.suntheme4_2.common.timeoutSubmitForm(this.form, 'all');"
                            style="font-size: 18px; left: 336px; top: 192px; position: absolute" valueChangeListenerExpression="#{pages$ProductUnit$ProductUnitMaintenance.all_processValueChange}"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
