                    ...
                    <webuijsf:form id="form1">
                        <webuijsf:panelLayout id="layoutPanel1" panelLayout="flow" style="background-color: rgb(34, 45, 50); height: 662px; left: 0px; top: 0px; position: absolute; width: 238px">
                            ...
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnSupplier_action}" binding="#{pages$Menu.btnSupplier}" id="btnSupplier"
                                style="background-color: rgb(34, 45, 50); color: #ffffff; font-size: 18px; font-style: normal; left: 85px; top: 135px; position: absolute" text="Supplier"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnType_action}" binding="#{pages$Menu.btnType}" id="btnType"
                                style="background-color: rgb(34, 45, 50); color: rgb(255, 255, 255); font-size: 18px; font-style: normal; left: 65px; top: 160px; position: absolute" text="Product Type"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnBrand_action}" binding="#{pages$Menu.btnBrand}" id="btnBrand"
                                style="background-color: rgb(34, 45, 50); color: rgb(255, 255, 255); font-size: 18px; font-style: normal; left: 60px; top: 185px; position: absolute" text="Product Brand"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnUnit_action}" binding="#{pages$Menu.btnUnit}" id="btnUnit"
                                style="background-color: rgb(34, 45, 50); color: rgb(255, 255, 255); font-size: 18px; font-style: normal; left: 70px; top: 210px; position: absolute" text="Product Unit"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnVariance_action}" binding="#{pages$Menu.btnVariance}" id="btnVariance"
                                style="background-color: rgb(34, 45, 50); color: rgb(255, 255, 255); font-size: 18px; font-style: normal; left: 50px; top: 235px; position: absolute" text="Product Variance"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnProduct_action}" binding="#{pages$Menu.btnProduct}" id="btnProduct"
                                style="background-color: rgb(34, 45, 50); color: rgb(255, 255, 255); font-size: 18px; font-style: normal; left: 85px; top: 260px; position: absolute" text="Product"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnPackage_action}" binding="#{pages$Menu.btnPackage}" id="btnPackage"
                                style="background-color: rgb(34, 45, 50); color: rgb(255, 255, 255); font-size: 18px; font-style: normal; left: 82px; top: 285px; position: absolute" text="Package"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Menu.btnPromo_action}" binding="#{pages$Menu.btnPromo}" id="btnPromo"
                                style="background-color: rgb(34, 45, 50); color: rgb(255, 255, 255); font-size: 18px; font-style: normal; left: 90px; top: 310px; position: absolute" text="Promo"/>
