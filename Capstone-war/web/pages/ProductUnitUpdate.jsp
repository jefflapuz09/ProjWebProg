                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        <webuijsf:panelLayout id="layoutPanel1" panelLayout="flow" style="background-color: rgb(34, 45, 50); height: 662px; left: 0px; top: 0px; position: absolute; width: 238px">
                            <webuijsf:hyperlink actionExpression="#{pages$ProductUnitUpdate.purchaseOrder_action}" id="purchaseOrder"
                                style="color: rgb(255, 255, 255); font-size: 18px; left: 20px; top: 130px; position: absolute" text="Purchase Order"/>
                            <webuijsf:hyperlink actionExpression="#{pages$ProductUnitUpdate.receiveDelivery_action}" id="receiveDelivery"
                                style="color: rgb(255, 255, 255); font-size: 18px; left: 20px; top: 160px; position: absolute" text="Receive Delivery"/>
                            <webuijsf:hyperlink actionExpression="#{pages$ProductUnitUpdate.hyperlink1_action}" id="hyperlink1"
                        ...
                        <webuijsf:button actionExpression="#{pages$ProductUnitUpdate.btnSave_action}" binding="#{pages$SupplierMaintenanceCreate.btnSave}"
                        ...
                        <webuijsf:textField binding="#{pages$ProductUnitUpdate.txtName}" columns="40" id="txtName" style="font-size: 18px; left: 288px; top: 216px; position: absolute"/>
                        ...
                        <webuijsf:button actionExpression="#{pages$ProductUnitUpdate.btnBack_action}" binding="#{pages$SupplierMaintenanceCreate.btnBack}"
                        ...
                        <webuijsf:dropDown binding="#{pages$ProductUnitUpdate.category}" id="category"
                        ...
                        <webuijsf:textArea binding="#{pages$ProductUnitUpdate.txtDesc}" columns="118" id="txtDesc" rows="5" style="left: 288px; top: 288px; position: absolute"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
