                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        <webuijsf:panelLayout id="layoutPanel1" panelLayout="flow" style="background-color: rgb(34, 45, 50); height: 662px; left: 0px; top: 0px; position: absolute; width: 238px">
                            <webuijsf:hyperlink actionExpression="#{pages$Package$PackageMaintenance.hyperlink1_action}" id="hyperlink1"/>
                            <webuijsf:hyperlink actionExpression="#{pages$Package$PackageMaintenance.btnMenu_action}"
                                binding="#{pages$Package$PackageMaintenance.btnMenu}" id="btnMenu"
                        ...
                        <webuijsf:button actionExpression="#{pages$Package$PackageMaintenance.btnNew_action}"
                            binding="#{pages$Package$PackageMaintenance.btnNew}" id="btnNew"
                            style="font-size: 18px; left: 1031px; top: 192px; position: absolute" text="New Record"/>
                        <webuijsf:label id="label1" style="font-size: 36px; left: 336px; top: 120px; position: absolute; width: 502px" text="Package Maintenance"/>
                        <webuijsf:label id="label2" style="font-size: 18px; left: 456px; top: 192px; position: absolute" text="Search"/>
                        <webuijsf:textField binding="#{pages$Package$PackageMaintenance.txtSearch}" columns="40" id="txtSearch" style="font-size: 18px; left: 528px; top: 192px; position: absolute"/>
                        <webuijsf:button actionExpression="#{pages$Package$PackageMaintenance.btnSearch_action}"
                            binding="#{pages$Package$PackageMaintenance.btnSearch}" id="btnSearch"
                            style="font-size: 18px; left: 935px; top: 192px; position: absolute" text="Submit"/>
                        <webuijsf:checkbox binding="#{pages$Package$PackageMaintenance.all}" id="all" label="View all"
