            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:button actionExpression="#{pages$SupplierMaintenance.btnNew_action}" binding="#{pages$ProductUnitMaintenance.btnNew}"
                            ...
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="10" sourceData="#{SessionBean1.supplierData}" sourceVar="currentRow">
                                ...
                                <webuijsf:tableColumn binding="#{pages$SupplierMaintenance.tableColumn6}" headerText="Actions" id="tableColumn6" width="185">
                                    <webuijsf:button actionExpression="#{pages$SupplierMaintenance.btnUpdate_action}"
                                        binding="#{pages$ProductUnitMaintenance.btnUpdate}" id="btnUpdate" style="font-size: 18px" text="Update"/>
                                    <webuijsf:button actionExpression="#{pages$SupplierMaintenance.btnDelete_action}"
                                        binding="#{pages$ProductUnitMaintenance.btnDelete}" id="btnDelete" style="font-size: 18px" text="Deactivate"/>
                                </webuijsf:tableColumn>
                        ...
                        <webuijsf:button actionExpression="#{pages$SupplierMaintenance.btnSearch_action}" binding="#{pages$ProductUnitMaintenance.btnSearch}"
