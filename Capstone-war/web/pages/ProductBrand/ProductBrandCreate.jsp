            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:button actionExpression="#{pages$ProductBrand$ProductBrandCreate.btnSave_action}"
                            binding="#{pages$ProductBrand$ProductBrandCreate.btnSave}" id="btnSave" style="left: 287px; top: 480px; position: absolute" text="Save"/>
                        ...
                        <webuijsf:textField binding="#{pages$ProductBrand$ProductBrandCreate.txtName}" columns="40" id="txtName" style="font-size: 18px; left: 288px; top: 216px; position: absolute"/>
                        <webuijsf:messageGroup binding="#{pages$ProductBrand$ProductBrandCreate.messageGroup1}" id="messageGroup1" style="left: 1032px; top: 96px; position: absolute; width: 310px"/>
                        <webuijsf:button actionExpression="#{pages$ProductBrand$ProductBrandCreate.btnBack_action}"
                            binding="#{pages$ProductBrand$ProductBrandCreate.btnBack}" id="btnBack" style="left: 287px; top: 456px; position: absolute" text="Back"/>
                        <webuijsf:label id="label4" style="position: absolute; left: 288px; top: 264px" text="Product Type(s)*"/>
                        <webuijsf:dropDown binding="#{pages$ProductBrand$ProductBrandCreate.ptype}" id="ptype"
