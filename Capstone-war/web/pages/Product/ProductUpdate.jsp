                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        <webuijsf:panelLayout id="layoutPanel1" panelLayout="flow" style="background-color: rgb(34, 45, 50); height: 662px; left: 0px; top: 0px; position: absolute; width: 238px">
                            <webuijsf:hyperlink actionExpression="#{pages$Product$ProductUpdate.btnMenu_action}" id="btnMenu"
                        ...
                        <webuijsf:button actionExpression="#{pages$Product$ProductUpdate.btnSave_action}" binding="#{pages$Product$ProductUpdate.btnSave}"
                        ...
                        <webuijsf:messageGroup binding="#{pages$Product$ProductUpdate.messageGroup1}" id="messageGroup1" style="left: 1032px; top: 96px; position: absolute; width: 310px"/>
                        <webuijsf:button actionExpression="#{pages$Product$ProductUpdate.btnBack_action}" binding="#{pages$Product$ProductUpdate.btnBack}"
                        ...
                        <webuijsf:dropDown binding="#{pages$Product$ProductUpdate.prodtype}" id="prodtype"
                        ...
                        <webuijsf:dropDown binding="#{pages$Product$ProductUpdate.variance}" id="variance"
                        ...
                        <webuijsf:textField binding="#{pages$Product$ProductUpdate.txtProduct}" columns="30" id="txtProduct" style="font-size: 18px; left: 576px; top: 216px; position: absolute"/>
                        <webuijsf:label id="label6" style="position: absolute; left: 576px; top: 264px" text="Description"/>
                        <webuijsf:textArea binding="#{pages$Product$ProductUpdate.txtDescription}" columns="50" id="txtDescription" rows="4" style="left: 576px; top: 288px; position: absolute"/>
                        <webuijsf:label id="leb" style="left: 576px; top: 360px; position: absolute" text="Price*"/>
                        <webuijsf:textField binding="#{pages$Product$ProductUpdate.txtPrice}" columns="30" id="txtPrice" style="font-size: 18px; left: 576px; top: 384px; position: absolute"/>
                        <webuijsf:label id="label7" style="left: 576px; top: 432px; position: absolute" text="Reorder*"/>
                        <webuijsf:textField binding="#{pages$Product$ProductUpdate.txtReorder}" columns="30" id="txtReorder" style="font-size: 18px; left: 576px; top: 456px; position: absolute"/>
                        <webuijsf:label id="label8" style="left: 288px; top: 312px; position: absolute" text="Brand*"/>
                        <webuijsf:dropDown binding="#{pages$Product$ProductUpdate.brand}" id="brand"
