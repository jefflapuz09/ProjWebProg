                ...
                <webuijsf:body id="body1" style="-rave-layout: grid; background-color: #e6ebf2">
                    <webuijsf:form id="form1">
                        <webuijsf:panelLayout id="layoutPanel1" panelLayout="flow" style="background-color: rgb(34, 45, 50); height: 662px; left: 0px; top: 0px; position: absolute; width: 238px">
                            <webuijsf:hyperlink actionExpression="#{pages$ProductUnit$ProductUnitCreate.btnMenu_action}"
                                binding="#{pages$ProductUnit$ProductUnitCreate.btnMenu}" id="btnMenu"
                        ...
                        <webuijsf:button actionExpression="#{pages$ProductUnit$ProductUnitCreate.btnSave_action}"
                            binding="#{pages$ProductUnit$ProductUnitCreate.btnSave}" id="btnSave" style="left: 287px; top: 480px; position: absolute" text="Save"/>
                        ...
                        <webuijsf:textField binding="#{pages$ProductUnit$ProductUnitCreate.txtName}" columns="40" id="txtName" style="font-size: 18px; left: 288px; top: 216px; position: absolute"/>
                        <webuijsf:messageGroup binding="#{pages$ProductUnit$ProductUnitCreate.messageGroup1}" id="messageGroup1" style="left: 1032px; top: 96px; position: absolute; width: 310px"/>
                        <webuijsf:button actionExpression="#{pages$ProductUnit$ProductUnitCreate.btnBack_action}"
                            binding="#{pages$ProductUnit$ProductUnitCreate.btnBack}" id="btnBack" style="left: 287px; top: 456px; position: absolute" text="Back"/>
                        <webuijsf:label id="label3" style="left: 816px; top: 192px; position: absolute; width: 120px" text="Unit of Category*"/>
                        <webuijsf:dropDown binding="#{pages$ProductUnit$ProductUnitCreate.category}" id="category"
                        ...
                        <webuijsf:textArea binding="#{pages$ProductUnit$ProductUnitCreate.txtDesc}" columns="118" id="txtDesc" rows="5" style="left: 288px; top: 288px; position: absolute"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
